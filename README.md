...
**Travis CI** (Ubuntu Linux): [![Build Status](https://travis-ci.com/MarkPThomas/MPT.Math-.netCore.svg?branch=master&kill_cache=1)](https://travis-ci.com/MarkPThomas/MPT.Math-.netCore) 
