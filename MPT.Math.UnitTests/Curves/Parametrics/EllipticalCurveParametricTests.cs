...
namespace MPT.Math.UnitTests.Curves.Parametrics
{
    ...
    public static class EllipticalCurveParametricTests
    {
        ...
        public static EllipticalCurveParametric parametricCircular;
        public static EllipticalCurveParametric parametricElliptical;

        [SetUp]
        public static void SetUp()
        {
            curveCircular = new CircularCurve(6, new CartesianCoordinate(4, 5));
            parametricCircular = new EllipticalCurveParametric(curveCircular);

            curveElliptical = new EllipticalCurve(3, 12, new CartesianCoordinate(4, 5), Angle.Origin());
            parametricElliptical = new EllipticalCurveParametric(curveElliptical);
        }
        ...
        {
            CartesianParametricEquationXY parametricCircularDifferential = parametricCircular.DifferentiateBy(0);
        ...
        {
            CartesianParametricEquationXY parametricCircularDifferential = parametricCircular.DifferentiateBy(differentialNumber);
            double xValue = parametricCircularDifferential.Xcomponent.ValueAt(position);
            Assert.AreEqual(expectedValueX, xValue);
            double yValue = parametricCircularDifferential.Ycomponent.ValueAt(position);
            Assert.AreEqual(expectedValueY, yValue);
        ...
        {
            CartesianParametricEquationXY parametricCircularPrimeFirst = parametricCircular.DifferentialFirst();
        ...
        {
            CartesianParametricEquationXY parametricCircularPrimeSecond = parametricCircular.DifferentialSecond();
            ...
            double expectedXPrimePrime, double expectedYPrimePrime)
        {
            ...
            // First differential
            Assert.IsTrue(parametricCircular.HasDifferential());
            CartesianParametricEquationXY parametricCircularPrime = parametricCircular.Differentiate();
            ...
            CartesianParametricEquationXY parametricCircularPrimePrime = parametricCircularPrime.Differentiate();
        ...
        {
            CartesianParametricEquationXY parametricCircularPrimePrime = parametricCircular.DifferentiateBy(2);
        ...
        public static void Multiplied_by_Constant_Scales_Values_Up_Circular(double position, double expectedValueX, double expectedValueY)
        {
            ...
            CartesianParametricEquationXY linearParametric = parametricCircular.DifferentiateBy(0) * scale;
