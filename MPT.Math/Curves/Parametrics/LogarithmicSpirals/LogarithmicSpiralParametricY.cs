...
namespace MPT.Math.Curves.Parametrics.LogarithmicSpirals
{
    ...
    /// Implements the <see cref="MPT.Math.Curves.Parametrics.LogarithmicSpirals.LogarithmicSpiralParametricBase" />
    /// </summary>
    /// <seealso cref="MPT.Math.Curves.Parametrics.LogarithmicSpirals.LogarithmicSpiralParametricBase" />
    internal class LogarithmicSpiralParametricY : LogarithmicSpiralParametricBase
    {
