...
namespace MPT.Math.Curves.Parametrics.BezierCurves
{
    ...
    internal class BezierParametric2ndOrderX : BezierParametricDoubleComponents
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BezierParametric2ndOrderX" /> class.
        /// </summary>
        /// <param name="parent">The parent.</param>
        public BezierParametric2ndOrderX(BezierCurve parent) : base(parent)
        {
        }
        ...
        {
            return new BezierParametric2ndOrderP(_parent).BaseByParameter(parameter).X;
        }
        ...
        {
            return new BezierParametric2ndOrderP(_parent).PrimeByParameter(parameter).X;
        }
        ...
        {
            return new BezierParametric2ndOrderP(_parent).PrimeDoubleByParameter(parameter).X;
        }
        #endregion
        ...
        public BezierParametric2ndOrderX CloneParametric()
        {
            BezierParametric2ndOrderX parametric = new BezierParametric2ndOrderX(_parent as BezierCurve);
            return parametric;
        }
        #endregion
    }
