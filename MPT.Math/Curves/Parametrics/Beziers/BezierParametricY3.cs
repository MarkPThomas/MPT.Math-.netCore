...
namespace MPT.Math.Curves.Parametrics.Beziers
{
    ...
    internal class BezierParametricY3 : BezierParametricLinearBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BezierParametricX1" /> class.
        /// </summary>
        /// <param name="parent">The parent.</param>
        public BezierParametricY3(BezierCurve parent) : base(parent)
        {
        }
        ...
        {
            return new BezierParametricP3(_parent).BaseByParameter(parameter).Y;
        }
        ...
        {
            return new BezierParametricP3(_parent).PrimeByParameter(parameter).Y;
        }
        ...
        {
            return new BezierParametricP3(_parent).PrimeDoubleByParameter(parameter).Y;
        }
        #endregion
        ...
        public BezierParametricY3 CloneParametric()
        {
            BezierParametricY3 parametric = new BezierParametricY3(_parent as BezierCurve);
            return parametric;
        }
        #endregion
    }
