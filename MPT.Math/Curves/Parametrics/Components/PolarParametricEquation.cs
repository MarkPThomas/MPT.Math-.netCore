...
{
    /// <summary>
    /// Represents a set of parametric equations in radial <see cref="double"/> and rotational <see cref="Angle"/> components, such as polar coordinates systems.
    ...
    public class PolarParametricEquation : IParametricPolar<DoubleParametricComponent, AngularParametricComponent>, ICloneable
    {
        /// <summary>
        ...
        /// The x
        /// </summary>
        internal DoubleParametricComponents _radius;
        /// <summary>
        /// The x-component, at position s.
        /// </summary>
        /// <value>The xcomponent.</value>
        public DoubleParametricComponent Radius => _radius[_differentiationIndex];

        /// <summary>
        /// The y
        /// </summary>
        internal AngularParametricComponents _azimuth;
        /// <summary>
        ...
        public PolarParametricEquation Differentiate()
        {
            ...
            differential._radius = _radius.Differentiate(_differentiationIndex) as DoubleParametricComponents;
            differential._azimuth = _azimuth.Differentiate(_differentiationIndex) as AngularParametricComponents;
