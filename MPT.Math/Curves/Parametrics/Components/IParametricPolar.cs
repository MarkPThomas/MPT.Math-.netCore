...
{
    /// <summary>
    /// Represents a set of parametric equations in radius <see cref="double"/> and rotational <see cref="Angle"/> components, such as polar coordinates systems.
    /// </summary>
    public interface IParametricPolar<T1, T2> 
