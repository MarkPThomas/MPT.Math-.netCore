...
{
    /// <summary>
    /// Class containing the assigned components of a parametric equation in <see cref="CartesianCoordinate"/> coordinates and the corresponding linear curve object.
    ...
    internal abstract class LinearParametricCartesianComponents : CartesianParametricComponents
    {
        /// <summary>
        ...
        public LinearParametricCartesianComponents(LinearCurve parent) : base(parent) { }
    }
}
