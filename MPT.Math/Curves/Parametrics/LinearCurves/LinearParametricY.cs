...
namespace MPT.Math.Curves.Parametrics.LinearCurves
{
    ...
    /// Implements the <see cref="MPT.Math.Curves.Parametrics.LinearCurves.LinearParametricDoubleComponents" />
    /// </summary>
    /// <seealso cref="MPT.Math.Curves.Parametrics.LinearCurves.LinearParametricDoubleComponents" />
    internal class LinearParametricY : LinearParametricDoubleComponents
    {
