...
// TODO: See if later implemending SIMD: https://msdn.microsoft.com/en-us/library/system.numerics(v=vs.111).aspx
...
namespace MPT.Math
{
    ...
    public static class Numbers
    {
        ...
        public static bool IsGreaterThanOrEqualTo(this double value1, double value2, double tolerance = ZeroTolerance)
        {
            return (value1.IsGreaterThan(value2, tolerance) || AreEqual(value2, value2, tolerance));
        }
        ...
        public static bool IsLessThanOrEqualTo(this double value1, double value2, double tolerance = ZeroTolerance)
        {
            return (value1.IsLessThan(value2, tolerance) || AreEqual(value2, value2, tolerance));
        }
        #endregion
        ...
        /// <param name="value">The value.</param>
        /// <returns>System.Double.</returns>
        public static double CubeRoot(int value)
        {
            return value.Pow(1 / 3);
        }
